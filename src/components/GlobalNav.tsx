...
import { Sun, Moon, Menu, X, Zap, Layers } from "lucide-react";
    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/10 bg-background/80 backdrop-blur-md">
      <div className="container mx-auto px-4 h-14 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-1">
          ...
          <Link href="/artifacts" className="font-[Orbitron] text-[9px] tracking-[2px] uppercase px-3 py-2 text-muted-foreground hover:text-primary transition-colors">
            Artifacts
          </Link>
      ...
      {mobileOpen && (
        <div className="lg:hidden border-t border-border/30 bg-background/95 backdrop-blur-md px-4 py-4 flex flex-col gap-1">
          ...
          <Link href="/artifacts" onClick={() => setMobileOpen(false)} className="font-[Orbitron] text-[10px] tracking-[2px] uppercase px-3 py-2.5 text-muted-foreground hover:text-primary transition-colors flex items-center gap-1"><Layers className="w-3 h-3" /> Artifacts</Link>
