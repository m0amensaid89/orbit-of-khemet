            ...
            >
              ...
              <div>
                ...
                <div className="flex justify-between items-center mt-3">
                  ...
                  <p className="font-[Rajdhani] text-xs text-[#D4AF37]">{lang === 'ar' ? 'المحادثات: ' : 'Total Threads: '}{userData.threadsCount} | {lang === 'ar' ? 'الرسائل: ' : 'Total Messages: '}{userData.messagesSent} | {stats.nextLevelXp - stats.currentXp} {lang === 'ar' ? 'نقطة للمستوى التالي' : 'XP to go'}</p>
                </div>
              </div>
            </motion.div>
