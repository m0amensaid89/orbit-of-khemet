...
const heroes = [
  {
    id: 1, name: "NEXAR", slug: "nexar",
    role: "The Destabilizer",
    description: "Destroys weak inputs and demands high-leverage context.",
    accentColor: "#FF4444", glowColor: "rgba(255,68,68,0.35)",
  },
  {
    id: 2, name: "HORUSEN", slug: "horusen",
    role: "Ancient Script Guardian",
    description: "Oversees the grand board, plotting multi-step empire growth.",
    accentColor: "#D4AF37", glowColor: "rgba(212,175,55,0.35)",
  },
  {
    id: 3, name: "KAIRO", slug: "kairo",
    role: "Precision Stream Warrior",
    description: "Structures chaos into scalable, unbreakable precision.",
    accentColor: "#00E5FF", glowColor: "rgba(0,229,255,0.35)",
  },
  {
    id: 4, name: "LYRA", slug: "lyra",
    role: "Visionary Systems Architect",
    description: "Weaves compelling narratives that captivate and convert.",
    accentColor: "#D4AF37", glowColor: "rgba(212,175,55,0.35)",
  },
  {
    id: 5, name: "NEFRA", slug: "nefra",
    role: "Precision Stream Warrior",
    description: "Reads between the lines, ensuring tone aligns with intent.",
    accentColor: "#E040FB", glowColor: "rgba(224,64,251,0.35)",
  },
  {
    id: 6, name: "RAMET", slug: "ramet",
    role: "The Stabilizer",
    description: "Turns ideas into precise, high-speed, flawless execution.",
    accentColor: "#4ECDC4", glowColor: "rgba(78,205,196,0.35)",
  },
  {
    id: 7, name: "THOREN", slug: "thoren",
    role: "The Law",
    description: "Protects the core, ensuring safe and sustainable operations.",
    accentColor: "#D4AF37", glowColor: "rgba(212,175,55,0.35)",
  },
];
...
export default function HubPage() {
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col relative pb-32">
